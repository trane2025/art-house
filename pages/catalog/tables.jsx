...
function tables({ title, cardsGoods, prelouder, setPrelouder, numberPage, selectOption, page, resolvedUrl, pageLinks, breadCrumbs }) {


    // useEffect(() => {
    //     Axios.get('https://server.arthouse-decor.ru/server/app_with_pagination_test.php?page=tables&t_table_top=shpon&t_color=dub').then(res => {
...
export default connect(mapStateToProps, { setPrelouder })(tables);
